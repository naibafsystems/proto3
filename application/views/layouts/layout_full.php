...
<html lang="en">
    <head>
        ...
        <![endif]-->
        <!--<script async defer
                    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDt__a_n1IUtBPqj9ntMD5cNG8gYlcovWM&libraries=places">
                </script> -->
    </head>
    <body role="document">
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav nav navbar-nav">
                        ...
                        <li class="leaf"><a href="<?php echo $urlSomos?>?q=search/node">Descubre lo que otros saben</a></li>
