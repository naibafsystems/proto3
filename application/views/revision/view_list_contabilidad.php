<?php if ($this->session->userdata('logueado')) { ?>
    ...
    <h1>Contabilidad</h1>
    <p class="text-justify"><br/>En el siguiente listado apareceran las comisiones que estan en contabilidad para su respectivo proceso</p>
										...
										?>
											<div class="col-md-10 col-md-offset-1"> 
												<div class="col-md-12">
													...
													<p>
														<textarea rows="3" name="observaciones" id="observaciones" placeholder="Observaciones" class="form-control validate[required]">N&uacute;mero Obligaci&oacute;n: </textarea>
													</p>
										...
										<div class="row">
											<div class="col-md-8 col-md-offset-2">
												<ul class="list-group">
													...
													?>
														<li class="list-group-item"><a href="<?php echo base_url('index.php/revision/generaWord/'.$listado_com_todos[0]->id_datos)?>"> Informe</a></li>
														<?php
														if(count($archivos) > 0){													
															for($an = 0;$an<count($archivos);$an++){
																?>
																	<li class="list-group-item"><a href="<?php echo $archivos[$an]->archivo_ruta."/".$archivos[$an]->archivo?>" target="_blank"> <?php echo $archivos[$an]->archivo?></a></li>
																<?php
															}
														}
														...
														if(count($ar_rutas) > 0){  													
															for($ar = 0;$ar<count($ar_rutas);$ar++){
																?>
																<li class="list-group-item"><a href="<?php echo $ar_rutas[$ar]->archivo_ruta."/".$ar_rutas[$ar]->archivo?>" target="_blank"> <?php echo $ar_rutas[$ar]->archivo?></a></li>
																<?php
															}
														}
														?>
										...
										?>
											<div class="col-md-10 col-md-offset-1"> 
												<div class="col-md-12">
													...
													<p>
														<textarea rows="3" name="observaciones" id="observaciones" placeholder="Observaciones" class="form-control validate[required]">N&uacute;mero comprobante contable: </textarea>
													</p>
													<p><button type="submit" class="btn btn-lg btn-success btn-block" value="<?php echo $id?>">Guardar</button></p>  
												</div>
											</div>
