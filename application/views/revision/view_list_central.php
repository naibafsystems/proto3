<?php if ($this->session->userdata('logueado')) { ?>
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Central de cuentas</li>
    </ol>
    <h1>Central de cuentas</h1>
    <p class="text-justify"><br/>En el siguiente listado apareceran las comisiones que estan en central de cuentas para su respectivo proceso</p>
	...
	if ($retornoError) {
		...
		<div>
		  ...
		  <ul class="nav nav-tabs" role="tablist">
			<li role="presentation" class="active"><a href="#plegalizar" aria-controls="plegalizar" role="tab" data-toggle="tab">Comisiones cuenta</a></li>
							...
							<div class="row" <?php echo $class?>>
								...
								<div class="row">
									<div class="col-md-8">
										...
										$listadocc = $this->M_revision->grupo_cc();
